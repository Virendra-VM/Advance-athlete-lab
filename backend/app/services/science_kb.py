...
TOPIC_SYNONYMS = {
    "taper": ["periodization"],
    "peak": ["periodization"],
    "base": ["base", "periodization", "weekly-structure"],
    "block": ["periodization"],
    ...
    "plan": ["planning", "weekly-structure", "templates", "diy"],
    ...
    "vagal": ["hrv", "rmssd", "recovery", "readiness"],
    ...
    "fueling": ["fueling", "carbohydrate", "glycogen", "long"],
    ...
    "restriction": ["bfr", "aop", "safety", "strength"],
    "ibuprofen": ["safety", "policy"],
    "nsaid": ["safety", "policy"],
    "nsaids": ["safety", "policy"],
    # New packs: base rebuild, long sessions, DIY negotiation
    "diy": ["diy", "planning", "weekly-structure"],
    "propose": ["diy", "planning"],
    "proposed": ["diy", "planning"],
    "negotiate": ["diy", "communication", "planning"],
    "rebuild": ["base", "periodization", "progression"],
    "travel": ["travel", "heat", "environment", "recovery"],
    "mountain": ["mountain", "long", "ride"],
    "double": ["double", "weekly-structure", "sessions"],
    "doubles": ["double", "weekly-structure"],
    "long": ["long", "sessions", "weekly-structure"],
    "absorb": ["recovery-week", "recovery", "base"],
    "absorption": ["recovery-week", "recovery", "base"],
    "hero": ["long", "load-management", "injury-prevention"],
    "weekend": ["long", "diy", "weekly-structure"],
    "softcap": ["readiness", "sleep", "autoregulation"],
    "restore": ["readiness", "recovery", "sleep"],
    "calendar": ["diy", "planning", "weekly-structure"],
    "schedule": ["planning", "weekly-structure", "diy"],
    "spine": ["spine", "safety", "strength"],
    "grey": ["intensity", "zones"],
    "gray": ["intensity", "zones"],
    "conversational": ["intensity", "zones", "base"],
    "endurance": ["sessions", "long", "base"],
    "reopen": ["base", "periodization"],
    "handoff": ["base", "travel", "recovery-week"],
    "camp": ["travel", "heat", "recovery"],
    "fuel": ["fueling", "carbohydrate", "long"],
    "climb": ["mountain", "long"],
    "hilly": ["mountain", "long"],
    "hills": ["mountain", "long", "sessions"],
    "missed": ["diy", "communication", "planning"],
    "unplanned": ["diy", "planning"],
    "logged": ["diy", "load-management"],
    "completed": ["diy", "planning"],
    "rewrite": ["diy", "communication"],
    "library": ["diy", "planning"],
    "yoga": ["mobility"],
    "core": ["strength", "spine"],
    # Workload / HRV / female / ortho packs
    "ctl": ["ctl", "atl", "tsb", "load-management"],
    "atl": ["ctl", "atl", "tsb", "load-management"],
    "tsb": ["ctl", "atl", "tsb", "load-management", "race-prep"],
    "banister": ["banister", "ctl", "atl", "tsb"],
    "fitness": ["ctl", "load-management", "periodization"],
    "fatigue": ["atl", "recovery", "load-management"],
    "ewma": ["ewma", "acwr", "load-management"],
    "gabbett": ["acwr", "injury-prevention", "load-management"],
    "rmssd": ["rmssd", "hrv", "readiness"],
    "baseline": ["baseline", "hrv", "rmssd"],
    "autonomic": ["hrv", "rmssd", "readiness"],
    "swot": ["hrv", "autoregulation", "swot"],
    "follicular": ["follicular", "menstrual-cycle", "glycogen"],
    "luteal": ["luteal", "menstrual-cycle", "heat", "carbohydrate"],
    "menstrual": ["menstrual-cycle", "female-athlete"],
    "eumenorrheic": ["menstrual-cycle", "female-athlete"],
    "hormonal": ["menstrual-cycle", "female-athlete"],
    "mcgill": ["mcgill", "spine", "strength"],
    "tendinopathy": ["tendinopathy", "injury", "achilles"],
    "tendon": ["tendinopathy", "injury"],
    "achilles": ["tendinopathy", "achilles", "injury"],
    "patellar": ["tendinopathy", "injury"],
    "bfr": ["bfr", "aop", "safety", "strength"],
    "occlusion": ["bfr", "aop", "safety"],
    "aop": ["aop", "bfr", "safety"],
    "cuff": ["bfr", "aop", "safety"],
    "mmhg": ["bfr", "aop", "safety"],
}
